...
const employeeRoute = () => {
    ...
    route.patch("/:id", validateUUIDMiddleware, verifyTokenMiddleware, validateSchemaMiddleware(updateEmploeeSchema), verifyAdminPermissionMiddleware, EmployeeController.updateEmployee)
    route.delete("/:id", validateUUIDMiddleware, verifyTokenMiddleware, verifyAdminPermissionMiddleware, EmployeeController.deleteEmployee)
